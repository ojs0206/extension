        ...
        @if ($info != NULL)
            <form action="<?=url('/update_billing')?>" method="post" id="newBillingProfile" name="newBillingProfile">
                ...
                <div class="row info">
                    ...
                    <select name="user_profile_name" class="billing-form" id="username" placeholder="" required>
    ...
    <div class="modal" id="paypal_payment">
        <div class="modal-content">
            ...
            <div class="panel-body">
                <form action="/payment/paypal" method="post" id="frm-paypal" name="frm-paypal" target="TheWindow">
                    {{ csrf_field() }}
                    <div class="row">
...
@section('js4page')
    <script>
        function connectPP() {
            window.open('/payment/paypal', 'TheWindow', 'width=900,height=900');
